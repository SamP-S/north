...
from north.service.board.parser import ParseError, parse_conversation, parse_task
...
def test_pending_queue_ordering(board_repo: Path) -> None:
    import north.service.main as main_module
    from north.service.main import app
