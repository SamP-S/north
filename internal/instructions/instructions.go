// Package instructions is the single source for the agent-facing guidance.
//
// `north init` writes this to AGENTS.md at the repo root. Keep it short and
// operational — it tells an agent how to drive the board via the CLI (and MCP).
package instructions

const agents = `# North — task board for agents
...
// AgentsMD returns the AGENTS.md text.
