...
def edit(args: argparse.Namespace, ctx: NorthContext) -> int:
    ...
    ctx.board.put(f"/api/projects/{args.project}/features/{args.feature}", body=body)
...
def delete(args: argparse.Namespace, ctx: NorthContext) -> int:
    ...
    if not args.yes and not confirm(
        ...
        print("aborted")
        return 0
    ctx.board.delete(f"/api/projects/{args.project}/features/{args.feature}")
...
def promote(args: argparse.Namespace, ctx: NorthContext) -> int:
    ...
    ctx.board.post(f"/api/projects/{args.project}/features/{args.feature}/promote")
