"""Tests for the Borealis MCP surface: grant filtering, token auth, write parity."""
...
import pytest
from borealis.service.api.deps import set_board_context
from borealis.service.mcp import GRANTS, mount_mcp, parse_token_map
