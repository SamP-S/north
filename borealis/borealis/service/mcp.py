"""Borealis MCP surface: curated tools over the same service layer as REST.
...
from borealis.service.api import comments as comments_api
from borealis.service.api import conversations as conversations_api
from borealis.service.api import features as features_api
from borealis.service.api import tasks as tasks_api
from borealis.service.api.deps import acquire_board_context
from borealis.service.models import ConversationStatus, FeatureStatus
...
def build_grant_server(
    ...
    server = FastMCP(
        f"borealis-{grant}",
        instructions=f"Borealis board access with the '{grant}' grant set.",
        stateless_http=True,
        json_response=True,
